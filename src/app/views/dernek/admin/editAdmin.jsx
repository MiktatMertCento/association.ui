...
const EditAdmin = (props) => {
    ...
    const genelColumnDefinitionOfSchedule = [
        ...
        { headerName: "Düzenle", field: "edit", cellRenderer: EditAdminDialog, cellRendererParams: { getAdminList: getAdminList }, minWidth: 130, editable: false, sortable: false, filter: false },
        { headerName: "Sil", field: "delete", cellRenderer: DeleteAdminDialog, cellRendererParams: { getAdminList: getAdminList }, minWidth: 130, editable: false, sortable: false, filter: false },
    ];
