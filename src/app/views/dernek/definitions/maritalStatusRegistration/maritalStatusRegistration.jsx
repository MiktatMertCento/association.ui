...
export default function MaritalStatusRegistration() {
  ...
  const genelColumnDefinitionOfSchedule = [
    { headerName: "Medeni Hal Numarası", field: "registerNo", minWidth: 130, editable: false, sortable: true, filter: true },
    { headerName: "Medeni Hal Adı", field: "registerName", minWidth: 130, editable: false, sortable: true, filter: true },
  ...
  const [usersRow, setUsersRow] = useState([
    {
      registerNo: "1",
      registerName: "Medeni Hal 1",
    },
    {
      registerNo: "2",
      registerName: "Medeni Hal 2",
    },
    {
      registerNo: "3",
      registerName: "Medeni Hal 3",
    },
  ]);
  ...
  return (
    <div className="m-sm-30">
      ...
      <div>
        <SimpleCard title="Medeni Hal Kayıt">
          <form>
            <Controller
              render={({ field }) =>
                <TextField
        ...
        <SimpleCard title="Medeni Haller">
