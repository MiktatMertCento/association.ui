...
import { deleteUserType } from 'app/services/service'
import { connect } from 'react-redux'

function DeleteUserTypeDialog(props) {
...

            {
                ...
                <Dialog
                    ...
                    <DialogActions>
                        ...
                        <Button variant="contained" color="primary" onClick={() => { props.deleteUserType(props.data.id, () => { setOpen(false); props.getParameters(); }, () => { }) }} autoFocus>
                            Evet
                        </Button>
                    </DialogActions>
                </Dialog>
