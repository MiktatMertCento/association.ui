...
export default function CityRegistration() {
  ...
  const genelColumnDefinitionOfSchedule = [
    { headerName: "Şehir Numarası", field: "registerNo", minWidth: 130, editable: false, sortable: true, filter: true },
    { headerName: "Şehir Adı", field: "registerName", minWidth: 130, editable: false, sortable: true, filter: true },
  ...
  const [usersRow, setUsersRow] = useState([
    {
      registerNo: "1",
      registerName: "Şehir 1",
    },
    {
      registerNo: "2",
      registerName: "Şehir 2",
    },
    {
      registerNo: "3",
      registerName: "Şehir 3",
    },
  ]);
      ...
      <div className="mb-sm-30">
        <Breadcrumb
          routeSegments={[
            ...
            { name: 'Şehir Tanımlama' },
          ]}
        />
      </div>

      <div>
        <SimpleCard title="Şehir Kayıt">
          <form>
            <Controller
              render={({ field }) =>
                <TextField
