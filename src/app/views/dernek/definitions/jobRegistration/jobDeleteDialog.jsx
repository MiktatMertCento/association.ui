...
import { deleteJob } from 'app/services/service'
...

            {
                ...
                <Dialog
                    ...
                    <DialogActions>
                        ...
                        <Button variant="contained" color="primary" onClick={() => { props.deleteJob(props.data.id, () => { setOpen(false); props.getParameters(); }, () => { }) }} autoFocus>
                            Evet
                        </Button>
                    </DialogActions>
                </Dialog>
