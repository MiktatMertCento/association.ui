...
export default function DistrictRegistration() {
  ...
  const genelColumnDefinitionOfSchedule = [
    { headerName: "Mahalle Numarası", field: "registerNo", minWidth: 130, editable: false, sortable: true, filter: true },
    { headerName: "Mahalle Adı", field: "registerName", minWidth: 130, editable: false, sortable: true, filter: true },
  ...
  const [usersRow, setUsersRow] = useState([
    {
      registerNo: "1",
      registerName: "Mahalle 1",
    },
    {
      registerNo: "2",
      registerName: "Mahalle 2",
    },
    {
      registerNo: "3",
      registerName: "Mahalle 3",
    },
  ]);
      ...
      <div className="mb-sm-30">
        <Breadcrumb
          routeSegments={[
            ...
            { name: 'Mahalle Tanımlama' },
          ]}
        />
      </div>

      <div>
        <SimpleCard title="Mahalle Kayıt">
          <form>
