...
import { deleteDistrict } from 'app/services/service'
import { connect } from 'react-redux'

function DeleteDistrictDialog(props) {
...

            {
                ...
                <Dialog
                    ...
                    <DialogActions>
                        ...
                        <Button variant="contained" color="primary" onClick={() => { props.deleteDistrict(props.data.id, () => { setOpen(false); props.getParameters(); }, () => { }) }} autoFocus>
                            Evet
                        </Button>
                    </DialogActions>
                </Dialog>
