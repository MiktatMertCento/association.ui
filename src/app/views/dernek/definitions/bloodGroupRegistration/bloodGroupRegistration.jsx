...
export default function BloodGroupRegistration() {
  ...
  const genelColumnDefinitionOfSchedule = [
    { headerName: "Kan Grubu Numarası", field: "registerNo", minWidth: 130, editable: false, sortable: true, filter: true },
    { headerName: "Kan Grubu Adı", field: "registerName", minWidth: 130, editable: false, sortable: true, filter: true },
  ...
  const [usersRow, setUsersRow] = useState([
    {
      registerNo: "1",
      registerName: "Kan Grubu 1",
    },
    {
      registerNo: "2",
      registerName: "Kan Grubu 2",
    },
    {
      registerNo: "3",
      registerName: "Kan Grubu 3",
    },
  ]);
  ...
  return (
    <div className="m-sm-30">
      ...
      <div>
        <SimpleCard title="Kan Grubu Kayıt">
          <form>
            <Controller
              render={({ field }) =>
                <TextField
